...
func (o *SwaggerSpec) initHandlerCache() {
	...
	o.Handlers["DELETE"]["/api/v1/kms/keys/{keyId}"] = true
	o.Handlers["DELETE"]["/api/v1/kms/policies/{policyId}"] = true
	o.Handlers["DELETE"]["/api/v1/kms/secrets/{keyId}"] = true
	...
	o.Handlers["GET"]["/api/v1/kms/audit-logs"] = true
	o.Handlers["GET"]["/api/v1/auth/register"] = true
	o.Handlers["GET"]["/-/healthy"] = true
	o.Handlers["GET"]["/api/v1/kms/keys/{keyId}"] = true
	o.Handlers["GET"]["/api/v1/kms/keys"] = true
	o.Handlers["GET"]["/api/v1/kms/policies"] = true
	o.Handlers["GET"]["/api/v1/kms/policies/{policyId}"] = true
	o.Handlers["GET"]["/-/ready"] = true
	o.Handlers["GET"]["/api/v1/kms/secrets/{keyId}"] = true
	o.Handlers["GET"]["/swagger.yml"] = true
	o.Handlers["GET"]["/api/v1/auth/userinfo"] = true
	o.Handlers["GET"]["/-/version"] = true
	o.Handlers["HEAD"]["/api/v1/kms/secrets/{keyId}"] = true
	o.Handlers["POST"]["/api/v1/auth/change-password"] = true
	o.Handlers["POST"]["/api/v1/auth/register/{registrationToken}"] = true
	o.Handlers["POST"]["/api/v1/kms/keys"] = true
	o.Handlers["POST"]["/api/v1/kms/policies"] = true
	o.Handlers["POST"]["/api/v1/kms/secrets"] = true
	o.Handlers["POST"]["/api/v1/kms/decrypt"] = true
	o.Handlers["POST"]["/api/v1/kms/keys/{keyId}/disable"] = true
	o.Handlers["POST"]["/api/v1/kms/keys/{keyId}/enable"] = true
	o.Handlers["POST"]["/api/v1/kms/encrypt"] = true
	o.Handlers["POST"]["/api/v1/auth/forgot-password/complete"] = true
	o.Handlers["POST"]["/api/v1/auth/forgot-password"] = true
	o.Handlers["POST"]["/api/v1/kms/generate-data-key"] = true
	...
	o.Handlers["POST"]["/api/v1/kms/keys/{keyId}/rotate"] = true
	o.Handlers["POST"]["/api/v1/kms/sign"] = true
	o.Handlers["POST"]["/api/v1/kms/verify"] = true
	o.Handlers["PUT"]["/api/v1/kms/keys/{keyId}"] = true
	o.Handlers["PUT"]["/api/v1/kms/policies/{policyId}"] = true
	o.Handlers["PUT"]["/api/v1/push/token"] = true
	o.Handlers["PUT"]["/api/v1/kms/secrets/{keyId}"] = true
}
