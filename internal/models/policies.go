...
type Policy struct {
	...
	PolicyDocument types.JSON  `boil:"policy_document" json:"policy_document" toml:"policy_document" yaml:"policy_document"`
...
var PolicyTableColumns = struct {
	...
	PolicyDocument: "policies.policy_document",
...
var PolicyWhere = struct {
	...
	PolicyDocument whereHelpertypes_JSON
	CreatedAt      whereHelpertime_Time
	UpdatedAt      whereHelpertime_Time
}{
	PolicyID:       whereHelperstring{field: "\"policies\".\"policy_id\""},
	Description:    whereHelpernull_String{field: "\"policies\".\"description\""},
	PolicyDocument: whereHelpertypes_JSON{field: "\"policies\".\"policy_document\""},
	CreatedAt:      whereHelpertime_Time{field: "\"policies\".\"created_at\""},
	UpdatedAt:      whereHelpertime_Time{field: "\"policies\".\"updated_at\""},
}
...
var (
	policyAllColumns            = []string{"policy_id", "description", "policy_document", "created_at", "updated_at"}
	policyColumnsWithoutDefault = []string{"policy_id", "policy_document"}
	policyColumnsWithDefault    = []string{"description", "created_at", "updated_at"}
...
func FindPolicy(ctx context.Context, exec boil.ContextExecutor, policyID string, selectCols ...string) (*Policy, error) {
	policyObj := &Policy{}
	...
	query := fmt.Sprintf(
		"select %s from \"policies\" where \"policy_id\"=$1", sel,
	)
...
func (o *Policy) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"policies\" WHERE \"policy_id\"=$1"
...
func PolicyExists(ctx context.Context, exec boil.ContextExecutor, policyID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"policies\" where \"policy_id\"=$1 limit 1)"
...
func (o *Policy) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return PolicyExists(ctx, exec, o.PolicyID)
}
