...
var (
	auditLogAllColumns            = []string{"id", "timestamp", "event_type", "user_id", "key_id", "operation", "result", "details", "ip_address"}
	auditLogColumnsWithoutDefault = []string{"event_type", "operation", "result"}
	auditLogColumnsWithDefault    = []string{"id", "timestamp", "user_id", "key_id", "details", "ip_address"}
